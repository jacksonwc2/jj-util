...
public class IfNull {
    ...
    /**
     * Quando o parâmetro "value" for igual a null a função deve retornar o valor do parâmetro "otherValue". <br>
     * Obs: O valor do parâmetro "otherValue" sempre deve ser do mesmo tipo do parâmetro "value". <br>
     * Ex 1: <br>
    ...
    public static <T> String get(T value, String otherValue) {
        if (value == null) {
            return otherValue;
        }
